...
const socketController = new SocketController('ws://192.168.1.202:3012',() => store.dispatch(setSocketController(socketController, true)));
//const socketController = new SocketController('ws://10.100.40.56:3012',() => store.dispatch(setSocketController(socketController, true)));
