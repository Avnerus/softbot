...
void Logger::Printf(const char *text1, const char* text2, const char* text3, int num1) {
        Serial.print(">D");
        Serial.print(text1);
        Serial.print(text2);
        Serial.print(text3);
...
void Logger::Printf(const char *text1, int num1) {
        Serial.print(">D");
        Serial.print(text1);
        Serial.print(num1);
        Serial.print("<");
...
void Logger::Printf(const char *text1, int num1, const char* text2, int num2) {
        Serial.print(">D");
        Serial.print(text1);
        Serial.print(num1);
        Serial.print(text2);
