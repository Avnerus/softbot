...
class Logger {
    ...
    public:
        ...
        static void Printf(const char *text1, int num1, const char* text2, int num2);
        static void Printf(const char *text1, int num1);
        static void Printf(const char *text1, const char* text2, const char* text3, int num1); 
};
